package kr.ac.uos.ai.mcarbi.monitor.log;
...
import kr.ac.uos.ai.mcarbi.monitor.log.argument.GoalArgument;
import kr.ac.uos.ai.mcarbi.monitor.log.argument.RelationArgument;
...
public class MonitorLogger implements WorldModelChangeListener, IntentionStructureChangeListener{
	...
	private MonitoringAgent	 	monitorAgent;
	private Interpreter 		interpreter;
	
	
	public MonitorLogger(MonitoringAgent monitorAgent, Interpreter interpreter) {
